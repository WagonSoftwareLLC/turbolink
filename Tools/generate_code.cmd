...
if "%3" NEQ "" set ADDITIONAL_INCLUDE= --proto_path="%3"
::call protoc.exe
"%PROTOC_EXE_PATH%" ^
 --proto_path="%PROTOBUF_INC_PATH%" --proto_path="%INPUT_PROTO_PATH%" %ADDITIONAL_INCLUDE%^
 ...
 %INPUT_PROTO_PATH%\%INPUT_PROTO_FILE%
